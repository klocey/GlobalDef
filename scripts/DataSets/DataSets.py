...
OUT = open('DataSets.txt', 'w+')
OUT.write(outstring+'\n')
OUT.close()



names = ['JFish', 'ROM', 'Mosquito', 'UofVienna', 'Africa', 'CASzoo', 'CMHerps',
         'CONN', 'Arctic', 'WTU', 'LACM', 'Geneva', 'CMBird', 'Macaulay', 
         'Eumyceto', 'AMNH-M', 'Edaph', 'TexAM', 'MAL', 'OSUC', 'Neptune',
         'UCFC', 'AMNH-B', 'IllNat', 'UPS', 'FishBase', 'BPBM', 'MICROBIS',
         'RoyBot', 'PRECIS', 'Hatikka', 'SAFRING', 'giezen', 'Plank',
         'PaleoB', 'PlutoF', 'PhanBotan']


for name in names:
    
    OUT = open('DataSets.txt', 'a+')
